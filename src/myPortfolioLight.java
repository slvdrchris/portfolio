...
public class myPortfolioLight {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					myPortfolioLight window = new myPortfolioLight();
	...
	private void initialize() {
		...
		home_0.setBackground(new Color(255, 255, 255));
		...
		piggy.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/piggyS.png")));
		...
		btnProject.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				btnProject.setForeground(new Color(0, 0, 0));
				btnProject.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
				
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnProject.setForeground(new Color(0, 0, 255));
		...
		btnHome.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnHome.setForeground(new Color(0, 0, 255));;
		...
		btnAbout.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAbout.setForeground(new Color(0, 0, 255));
		...
		btnAbout.setForeground(new Color(0, 0, 0));
		btnAbout.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		btnAbout.setBounds(136, 22, 80, 34);
		home_0.add(btnAbout);
		...
		shortDesc.setForeground(new Color(0, 0, 0));
		...
		headMove.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) { //will move up
				...
				angriPig.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseEntered(MouseEvent e) {
						piggy.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/angri pig.png")));
					}
					@Override
					public void mouseExited(MouseEvent e) {
						piggy.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/piggyS.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/lightMode.png")));
		lblNewLabel_2.setBounds(350, 54, 486, 204);
		home_0.add(lblNewLabel_2);
		
		JLabel lblNewLabel_10 = new JLabel("");
		lblNewLabel_10.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				lblNewLabel_2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blueLightMode.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				lblNewLabel_2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/lightMode.png")));
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				myPortfolioDark darkMode = new myPortfolioDark();
				darkMode.main(null);
				frame.dispose();
			}
		});
		lblNewLabel_10.setBounds(629, 92, 71, 72);
		home_0.add(lblNewLabel_10);
		
		JSeparator separator;
		
		JPanel about_1 = new JPanel();
		about_1.setLayout(null);
		about_1.setBackground(new Color(255, 255, 255));
		tabbedPane.addTab("New tab", null, about_1, null);
		
				JLabel fbIcon = new JLabel("");
				fbIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-fb.png")));
				fbIcon.addMouseListener(new MouseAdapter() {
					...
					@Override
					public void mouseEntered(MouseEvent e) {
						fbIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-fb.png")));
					}
					@Override
					public void mouseExited(MouseEvent e) {
						fbIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-fb.png")));
				...
				instaIcon.addMouseListener(new MouseAdapter() {
					...
					@Override
					public void mouseEntered(MouseEvent e) {
						instaIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-instagram.png")));
					}
					@Override
					public void mouseExited(MouseEvent e) {
						instaIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-instagram.png")));
					}
				});
				instaIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-instagram.png")));
				...
				separatorAbout.setBackground(new Color(0, 0, 0));
				separatorAbout.setForeground(new Color(0, 0, 0));
				...
				btnProject_1.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseExited(MouseEvent e) {
						btnProject_1.setForeground(new Color(0, 0, 0));
						btnProject_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
					}
					@Override
					public void mouseEntered(MouseEvent e) {
						btnProject_1.setForeground(new Color(0, 0, 255));
				...
				btnHome_1.addMouseListener(new MouseAdapter() {
					...
					@Override
					public void mouseEntered(MouseEvent e) {
						btnHome_1.setForeground(new Color(0, 0, 255));
				...
				btnAbout_1.addMouseListener(new MouseAdapter() {
					...
					@Override
					public void mouseEntered(MouseEvent e) {
						btnAbout_1.setForeground(new Color(0, 0, 255));
				...
				btnExit_1.setBackground(new Color(0, 0, 0));
				btnExit_1.addMouseListener(new MouseAdapter() {
					...
					@Override
					public void mouseEntered(MouseEvent e) {
						btnExit_1.setForeground(new Color(0, 0, 255));
				...
				btnExit_1.setForeground(new Color(0, 0, 0));
				btnExit_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
				...
				JLabel lblNewLabel_4 = new JLabel("<html> My name is Christopher Robin Salvador and I am currently pursuing Bachelor of Science in Information Technology specialization with Multimedia Arts and Animation (BSIT-MAA) as I believe it will provide me with a solid foundation in the field of programming.");
				...
				imageSalvador.setForeground(new Color(0, 0, 255));
				imageSalvador.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-salvador.png")));
				...
				lblNewLabel_5_2_1.setForeground(new Color(0, 0, 255));
				...
				aboutDot1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
				...
				aboutDot2.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseEntered(MouseEvent e) {
						aboutDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
					}
					@Override
					public void mouseExited(MouseEvent e) {
						aboutDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
					}
					@Override
					public void mouseClicked(MouseEvent e) {
				...
				aboutDot3.addMouseListener(new MouseAdapter() {
					@Override
					public void mouseEntered(MouseEvent e) {
						aboutDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
					}
					@Override
					public void mouseExited(MouseEvent e) {
						aboutDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
					}
					@Override
					public void mouseClicked(MouseEvent e) {
				...
				nextSkills.addMouseListener(new MouseAdapter() {
					...
					@Override
					public void mouseEntered(MouseEvent e) {
						nextSkills.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-right.png")));
						
					}
					@Override
					public void mouseExited(MouseEvent e) {
						nextSkills.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/right-black.png")));
					}
				});
				nextSkills.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/right-black.png")));
				...
				txtpnSalvadorchristophergmailcom.setForeground(new Color(0, 0, 0));
				...
				separatorAbout_2.setBackground(new Color(0, 0, 0));
				separatorAbout_2.setForeground(new Color(0, 0, 0));
				separatorAbout_2.setBounds(416, 298, 358, 23);
				about_1.add(separatorAbout_2);
				
				JLabel lblNewLabel_6 = new JLabel("New label");
				lblNewLabel_6.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/au-logo.png")));
				lblNewLabel_6.setBounds(312, 333, 68, 66);
				about_1.add(lblNewLabel_6);
				
				JLabel lblNewLabel_6_1 = new JLabel("New label");
				lblNewLabel_6_1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/nu-logo.png")));
				...
				lblNewLabel_9_4.setForeground(new Color(0, 0, 255));
				...
				lblNewLabel_9_1_2_1.setForeground(new Color(0, 0, 0));
				...
				lblNewLabel_9_1_2_1_1.setForeground(new Color(0, 0, 0));
				...
				lblNewLabel_9_4_1.setForeground(new Color(0, 0, 255));
				...
				lblNewLabel_9_1_2_1_1_1.setForeground(new Color(0, 0, 0));
				...
				lblNewLabel_9_1_2_1_1_1_1.setForeground(new Color(0, 0, 0));
		...
		skills_2.setBackground(new Color(255, 255, 255));
		tabbedPane.addTab("New tab", null, skills_2, null);
		
		JSeparator separatorAbout_1 = new JSeparator();
		separatorAbout_1.setForeground(new Color(0, 0, 0));
		separatorAbout_1.setBackground(new Color(0, 0, 0));
		...
		btnProject_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnProject_1_1.setForeground(new Color(0, 0, 0));
				btnProject_1_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
				
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnProject_1_1.setForeground(new Color(0, 0, 255));
		...
		btnProject_1_1.setForeground(Color.BLACK);
		btnProject_1_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		...
		btnHome_1_1.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnHome_1_1.setForeground(new Color(0, 0, 255));
		...
		btnAbout_1_1.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAbout_1_1.setForeground(new Color(0, 0, 255));
		...
		btnExit_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnExit_1_1.setForeground(Color.BLACK);
				btnExit_1_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnExit_1_1.setForeground(new Color(0, 0, 255));
		...
		imageSalvador_1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-salvador.png")));
		imageSalvador_1.setBounds(58, 114, 207, 234);
		skills_2.add(imageSalvador_1);
		
		JLabel lblProgramming = new JLabel("Programming");
		lblProgramming.setForeground(new Color(0, 0, 0));
		...
		javaIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/java (1).png")));
		...
		pythonIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/python.png")));
		...
		lblNewLabel_9_1.setBounds(417, 202, 146, 23);
		skills_2.add(lblNewLabel_9_1);
		
		JLabel lblNewLabel_9_2 = new JLabel("<html>Python");
		lblNewLabel_9_2.setForeground(new Color(0, 0, 255));
		...
		autodeskIcon.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/autodesk_sketchbook.png")));
		autodeskIcon.setBounds(344, 302, 71, 71);
		skills_2.add(autodeskIcon);
		
		JLabel lblNewLabel_9_3 = new JLabel("<html>Autodesk Sketchbook");
		lblNewLabel_9_3.setForeground(new Color(0, 0, 255));
		...
		lblNewLabel_9_1_2.setForeground(new Color(0, 0, 0));
		...
		autodeskIcon_1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/gimpIcon.png")));
		autodeskIcon_1.setBounds(578, 302, 71, 64);
		skills_2.add(autodeskIcon_1);
		
		JLabel lblNewLabel_9_3_2 = new JLabel("<html>GIMP");
		lblNewLabel_9_3_2.setForeground(new Color(0, 0, 255));
		...
		lblNewLabel_9_1_2_2.setForeground(new Color(0, 0, 0));
		lblNewLabel_9_1_2_2.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 11));
		lblNewLabel_9_1_2_2.setBounds(655, 325, 150, 23);
		skills_2.add(lblNewLabel_9_1_2_2);
		
		JLabel dotSkills2 = new JLabel("");
		dotSkills2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
		...
		dotSkills1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				dotSkills1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				dotSkills1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(1);
		...
		dotSkill3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				dotSkill3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				dotSkill3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(3);
		...
		backAbout.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				backAbout.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-blue.png")));
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				backAbout.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-black.png")));
			}
		});
		backAbout.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-black.png")));
		...
		nextInterests.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				nextInterests.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-right.png")));
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				nextInterests.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/right-black.png")));
			}
		});
		...
		interests_3.setBackground(new Color(255, 255, 255));
		tabbedPane.addTab("New tab", null, interests_3, null);
		
		JSeparator separatorAbout_1_1 = new JSeparator();
		separatorAbout_1_1.setBackground(new Color(0, 0, 0));
		separatorAbout_1_1.setForeground(new Color(0, 0, 0));
		...
		btnProject_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnProject_1_1_1.setForeground(new Color(0, 0, 0));
				btnProject_1_1_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnProject_1_1_1.setForeground(new Color(0, 0, 255));
		...
		btnHome_1_1_1.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnHome_1_1_1.setForeground(new Color(0, 0, 255));
		...
		btnHome_1_1_1.setForeground(new Color(0, 0, 0));
		btnHome_1_1_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		btnHome_1_1_1.setBounds(37, 22, 71, 34);
		...
		btnAbout_1_1_1.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAbout_1_1_1.setForeground(new Color(0, 0, 255));
		...
		btnExit_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnExit_1_1_1.setForeground(Color.BLACK);
				btnExit_1_1_1.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnExit_1_1_1.setForeground(new Color(0, 0, 255));
		...
		lblInterests.setForeground(new Color(0, 0, 0));
		...
		imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-salvador.png")));
		...
		interestsDot2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				interestsDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interestsDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(2);
		...
		interestsDot1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				interestsDot1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interestsDot1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(1);
		...
		interestsDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
		...
		interests1.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/interestsImages/dark-movie.png")));
				imageSalvador_1_1.setBounds(37, 114, 234, 234);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interests1.setBackground(new Color(0, 64, 128));
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/images/black-salvador.png")));
				imageSalvador_1_1.setBounds(58, 114, 207, 234);
		...
		lblNewLabel_7.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/video-player.png")));
		...
		interests3.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/interestsImages/dark-drawing.png")));
				imageSalvador_1_1.setBounds(37, 114, 255, 234);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interests3.setBackground(new Color(0, 64, 128));
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/images/black-salvador.png")));
				imageSalvador_1_1.setBounds(58, 114, 207, 234);
			}
		});
		...
		lblNewLabel_7_2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/writing-tool.png")));
		...
		interests2.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/interestsImages/dark-music.png")));
				imageSalvador_1_1.setBounds(37, 114, 255, 234);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interests2.setBackground(new Color(0, 64, 128));
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/images/black-salvador.png")));
				imageSalvador_1_1.setBounds(58, 114, 207, 234);
			}
		});
		...
		lblNewLabel_7_2_3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/music.png")));
		...
		interests4.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/interestsImages/dark-games.png")));
				imageSalvador_1_1.setBounds(37, 102, 234, 270);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interests4.setBackground(new Color(0, 64, 128));
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/images/black-salvador.png")));
				imageSalvador_1_1.setBounds(58, 114, 207, 234);
			}
		});
		...
		lblNewLabel_7_2_2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/games.png")));
		...
		interests5.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/interestsImages/dark-pets.png")));
				imageSalvador_1_1.setBounds(37, 114, 234, 242);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interests5.setBackground(new Color(0, 64, 128));
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/images/black-salvador.png")));
				imageSalvador_1_1.setBounds(58, 114, 207, 234);
			}
		});
		...
		lblNewLabel_7_2_1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/animal-care.png")));
		...
		interests6.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/interestsImages/dark-craft.png")));
				imageSalvador_1_1.setBounds(37, 98, 234, 279);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				interests6.setBackground(new Color(0, 64, 128));
				imageSalvador_1_1.setIcon(new ImageIcon(myPortfolioDark.class.getResource("/images/black-salvador.png")));
				imageSalvador_1_1.setBounds(58, 114, 207, 234);
			}
		});
		...
		lblNewLabel_7_2_4.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/icons/origami.png")));
		...
		backSkills.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				backSkills.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-blue.png")));
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				backSkills.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-black.png")));
			}
		});
		...
		poster_4.setBackground(new Color(255, 255, 255));
		...
		btnProject_2.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnProject_2.setForeground(new Color(0, 0, 255));
		...
		btnHome_2.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnHome_2.setForeground(new Color(0, 0, 255));
		...
		btnHome_2.setForeground(new Color(0, 0, 0));
		btnHome_2.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		btnHome_2.setBounds(37, 22, 71, 34);
		...
		btnAbout_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnAbout_2.setForeground(Color.BLACK);
				btnAbout_2.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAbout_2.setForeground(new Color(0, 0, 255));
		...
		btnAbout_2.setForeground(new Color(0, 0, 0));
		btnAbout_2.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		btnAbout_2.setBounds(136, 22, 87, 34);
		poster_4.add(btnAbout_2);
		
		JLabel btnNextIllus = new JLabel("");
		btnNextIllus.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/right-black.png")));
		btnNextIllus.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnNextIllus.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-right.png")));
		...
		btnExit_2.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnExit_2.setForeground(new Color(0, 0, 255));
		...
		btnExit_2.setForeground(new Color(0, 0, 0));
		btnExit_2.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		...
		panel_4.setBackground(new Color(0, 64, 128,100));
		...
		panel_5.setBackground(new Color(0, 64, 128,100));
		...
		panel_6.setBackground(new Color(0, 64, 128,100));
		...
		works1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/work1.png")));
		works1.setBounds(10, 114, 816, 280);
		poster_4.add(works1);
		
		JSeparator separatorPoster;
		separatorPoster = new JSeparator();
		separatorPoster.setBackground(new Color(0, 0, 0));
		separatorPoster.setForeground(new Color(0, 0, 0));
		...
		posterDot3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				posterDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				posterDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(5);
		...
		poster1.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				zoomP1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/p1.png")));
				panel_4.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				zoomP1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel_4.setVisible(false);
			}
		...
		poster2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				zoomP2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/p2.png")));
				panel_5.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				zoomP2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel_5.setVisible(false);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		poster3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				zoomP3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/p3.png")));
				panel_6.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				zoomP3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel_6.setVisible(false);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		posterDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
		...
		posterDot4.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				posterDot4.setIcon(new ImageIcon(myPortfolioLight.class.getResource("images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				posterDot4.setIcon(new ImageIcon(myPortfolioLight.class.getResource("images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		illustration_5.setBackground(new Color(255, 255, 255));
		...
		btnProjectIllus.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnProjectIllus.setForeground(new Color(0, 0, 255));
		...
		btnHomeIllus.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnHomeIllus.setForeground(Color.BLACK);
				btnHomeIllus.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnHomeIllus.setForeground(new Color(0, 0, 255));
		...
		btnAboutIllus.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnAboutIllus.setForeground(Color.BLACK);
				btnAboutIllus.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAboutIllus.setForeground(new Color(0, 0, 255));
		...
		btnExitillus.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnExitillus.setForeground(Color.BLACK);
				btnExitillus.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnExitillus.setForeground(new Color(0, 0, 255));
		...
		btnExitillus.setForeground(new Color(0, 0, 0));
		btnExitillus.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		...
		panel_7.setBackground(new Color(0, 64, 128,100));
		...
		panel_8.setBackground(new Color(0, 64, 128,100));
		...
		panel_9.setBackground(new Color(0, 64, 128,100));
		...
		works2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/work2.png")));
		...
		labelPoster.setForeground(Color.BLACK);
		...
		illusDot3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				illusDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blueCircle.png")));
			}
			
		});
		illusDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
		...
		illusDot2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				illusDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				illusDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(4);
		...
		illusDot4.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				illusDot4.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				illusDot4.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(6);
		...
		btnNextGUI.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnNextGUI.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-right.png")));
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnNextGUI.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/right-black.png")));
			}
		});
		...
		btnBackPoster.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBackPoster.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-blue.png")));
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnBackPoster.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-black.png")));
			}
		});
		...
		illus1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				illusZoom1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/illus1.png")));
				panel_7.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				illusZoom1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel_7.setVisible(false);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		illus2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				illusZoom2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/illus2.png")));
				panel_8.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				illusZoom2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel_8.setVisible(false);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		illus3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				illusZoom3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/illus3.png")));
				panel_9.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				illusZoom3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel_9.setVisible(false);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		javaGUI_6.setBackground(new Color(255, 255, 255));
		...
		btnProjectGUI.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnProjectGUI.setForeground(new Color(0, 0, 255));
		...
		btnProjectGUI.setForeground(new Color(0, 0, 255));
		btnProjectGUI.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
		btnProjectGUI.setBounds(243, 22, 87, 34);
		...
		btnHomeGUI.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnHomeGUI.setForeground(Color.BLACK);
				btnHomeGUI.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnHomeGUI.setForeground(new Color(0, 0, 255));
		...
		btnAboutGUI.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnAboutGUI.setForeground(Color.BLACK);
				btnAboutGUI.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAboutGUI.setForeground(new Color(0, 0, 255));
		...
		btnExitGUI.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseExited(MouseEvent e) {
				btnExitGUI.setForeground(Color.BLACK);
				btnExitGUI.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
			}
			@Override
			public void mouseEntered(MouseEvent e) {
				btnExitGUI.setForeground(new Color(0, 0, 255));
		...
		panel_10.setBackground(new Color(0, 64, 128,100));
		...
		panel.setBackground(new Color(0, 64, 128,100));
		...
		viewP1_2_2_1.setBounds(149, 109, 119, 27);
		...
		works3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/work3.png")));
		...
		labelJavaGUI.setBackground(new Color(0, 0, 0));
		labelJavaGUI.setForeground(new Color(0, 0, 0));
		...
		guiDot3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				guiDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				guiDot3.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(5);
		...
		guiDot2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				guiDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				guiDot2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/black-circle.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				tabbedPane.setSelectedIndex(4);
		...
		guiDot4.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/blue-circle.png")));
		...
		btnBackIllus.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-black.png")));
		btnBackIllus.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBackIllus.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/images/left-blue.png")));
		...
		gui1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				guiZoom1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/gui1.png")));
				panel.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				guiZoom1.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel.setVisible(false);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		gui2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				guiZoom2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/gui2.png")));
				panel_10.setVisible(true);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				guiZoom2.setIcon(new ImageIcon(myPortfolioLight.class.getResource("/projectImages/blank.png")));
				panel_10.setVisible(false);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
